...
def main():
    ...
    print("      {")
    print('        "name": "get_account_status",')
    print('        "description": "Fetches the latest account status for a customer.",')
    print(f'        "url": "http://localhost:{args.port}{ACCOUNT_STATUS_TOOL_PATH}",')
    print('        "method": "POST",')
    print('        "execution_mode": "sync",')
    print('        "parameters": { "customer_id": "string" },')
    print('        "response": {')
    print('          "type": "object",')
    print('          "properties": {')
    print('            "status": { "type": "string" },')
    print('            "tier": { "type": "string" },')
    print('            "customer_id": { "type": "string" }')
    print('          }')
    print('        }')
    print("      }")
    print()
    print("    GET tool example:")
    print("      {")
    print('        "name": "search_kb",')
    print('        "description": "Searches the knowledge base for matching articles.",')
    print(f'        "url": "http://localhost:{args.port}{SEARCH_KB_TOOL_PATH}",')
    print('        "method": "GET",')
    print('        "execution_mode": "sync",')
    print('        "parameters": { "query": "string", "top_k": "number" },')
    print('        "response": {')
    print('          "type": "object",')
    print('          "properties": {')
    print('            "matches": { "type": "array" },')
    print('            "query": { "type": "string" },')
    print('            "top_k": { "type": "number" }')
    print('          }')
    print('        }')
    print("      }")
    print()
    print("  Notes:")
    print("    - Tool webhooks are outbound calls from Voice.ai to your server.")
    print("    - These example tool routes do not require auth_type/auth_token.")
    print("    - If you expose this server with ngrok, replace localhost with the ngrok URL.")
    print("=" * 60)
    print()
