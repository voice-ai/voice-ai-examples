...
- how to save the generated audio to disk
...
OUTPUT_FILE = "generated_speech.mp3"  # Update the extension if you change AUDIO_FORMAT
...
def main():
    ...
    try:
        ...
        print(f"✓ Wrote audio to {output_path} ({output_path.stat().st_size} bytes)")
